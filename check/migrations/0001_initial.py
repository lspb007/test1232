# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2018-03-07 07:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkmiddleware', models.CharField(choices=[('True', '正常'), ('Fales', '故障')], default='True', max_length=10, verbose_name='中间件')),
                ('checkdatabase', models.CharField(choices=[('True', '正常'), ('Fales', '故障')], default='True', max_length=10, verbose_name='数据库')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('psef', models.IntegerField(choices=[(1, '正常'), (2, '故障')], default=1, verbose_name='psef是否正常')),
